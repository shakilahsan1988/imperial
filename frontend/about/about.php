            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <p class="text-sm text-imperial-primary font-medium mb-4">Founder & Chair of the Board</p>
                        <a href="#" class="text-sm font-bold text-gray-500 hover:text-imperial-primary uppercase tracking-wide">See Details &rarr;</a>
                    </div>
                </div>
    ...
    <section class="py-16 md:py-24 bg-gray-50">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-imperial-gray mt-2 uppercase tracking-widest text-sm font-bold">We Provide the Best Healthcare to the Best of Bangladesh</p>
            </div>
