...
<main class="font-sans text-imperial-text bg-white pb-20">
    ...
    <!-- 
       ...
       Full-width background image with dark overlay and white text.
    -->
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12">
                    ...
                    <p class="text-gray-700 leading-relaxed text-lg">
                        At Imperial Health Bangladesh Limited, our reputation for integrity and excellence is our most valuable asset. This Code of Ethics outlines the principles and standards that guide our conduct. It applies to all employees, management, and medical staff. We are committed to the highest standards of ethical behavior in the delivery of healthcare services.
                    </p>
                </div>
