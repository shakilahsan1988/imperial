...
<!-- Main Content Start -->
<!-- Using bg-gray-50 to create contrast with the white header and cards -->
<main class="min-h-screen bg-gray-50 font-sans text-imperial-text flex flex-col">
    ...
    <section class="relative z-10 -mt-24 px-4">
        <div class="max-w-5xl mx-auto bg-white px-6 py-10 md:py-16 text-center shadow-xl rounded-xl border border-gray-100">    
            ...
            <p class="text-gray-600 max-w-3xl mx-auto font-roboto text-lg leading-relaxed">
                ...
                Our doctors have years of local and international experience and treat you with the 
    ...
    <section class="bg-white border-b border-gray-200 py-8 mt-8">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <form id="filterForm" class="grid grid-cols-1 md:grid-cols-12 gap-6 mb-8">
    ...
    <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-grow">
        ...
        <div class="mb-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                <!-- Card 1 -->
                <a href="#" class="group block bg-white rounded-xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
...
<!-- Script specifically for this page (Filtering Logic) -->
<script>
    document.addEventListener('DOMContentLoaded', () => {
        
        // --- DOCTOR PAGE SPECIFIC LOGIC ---
        ...
        if(filterForm) {
            filterForm.addEventListener('submit', (e) => {
                ...
                setTimeout(() => {
                    ...
                    // Show result alert (In a real app, you'd filter the DOM or AJAX)
...
<!-- Include Footer (contains closing </body> and </html>) -->
