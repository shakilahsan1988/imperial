    ...
    <header class="bg-white sticky top-0 z-10 shadow-sm transition-all duration-300" id="main-header">
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <!-- Logo -->
                <a href="http://localhost/index.php" class="flex-shrink-0 z-50">
                ...
                <nav class="hidden lg:flex gap-8 items-center">
                    <a href="http://localhost/index.php" class="text-imperial-text font-medium hover:text-imperial-primary transition">Home</a>
                    
                    <!-- MEGA MENU CONTAINER -->
                    <div class="relative group py-4"> 
                        <a href="http://localhost/services/services.php" class="text-imperial-text font-medium hover:text-imperial-primary transition flex items-center gap-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                                    ...
                                    <div>
                                        ...
                                        <ul class="space-y-2 mb-6">
                                            <li><a href="http://localhost/services/service-details.php" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Consultations</a></li>
                                            <li><a href="http://localhost/services/video-consultation.php" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Video Consultation</a></li>
                                        </ul>
                                        <h5 class="text-imperial-primary font-bold mb-4 uppercase text-sm tracking-wider">Health Checks</h5>
                                        <ul class="space-y-2">
                                            <li><a href="http://localhost/services/health-check.php" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Health Checks</a></li>
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Men's Health Packages</a></li>
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Senior Citizen Checks</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <ul class="space-y-2">
                                               <li><a href="http://localhost:8000/services/lab-test.php" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Diagnostics</a></li>
                                            <li><a href="http://localhost:8000/services/lab-test.php" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Lab Tests & Procedures</a></li>
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Imaging & X-Ray</a></li>
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Molecular Cancer Diagnostics</a></li>
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Home Sample Collection</a></li>
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Banani Hub</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <ul class="space-y-2">
                                            ...
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Vaccines</a></li>
                                            <li><a href="http://localhost/services/membership-plan.php" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Membership Plans</a></li>
                                            <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">COVID-19 Services</a></li>
                                        </ul>
                                    </div>
                    ...
                    <a href="#" class="text-imperial-text font-medium hover:text-imperial-primary transition">Our Doctors</a>
                    <a href="#" class="text-imperial-text font-medium hover:text-imperial-primary transition">imperialMD</a>
                    <a href="#" class="text-imperial-text font-medium hover:text-imperial-primary transition">About</a>
