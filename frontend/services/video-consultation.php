  ...
  <main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden flex flex-col h-full hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <a href="/services/3-month-video-consultation-plan/" class="block mb-2">
                        ...
                        <div class="text-center mt-2">
                            <a href="/services/3-month-video-consultation-plan/" class="text-sm font-semibold text-imperial-primary hover:underline">See details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden flex flex-col h-full hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <a href="/services/6-month-video-consultation-plan/" class="block mb-2">
                        ...
                        <div class="text-center mt-2">
                            <a href="/services/6-month-video-consultation-plan/" class="text-sm font-semibold text-imperial-primary hover:underline">See details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden flex flex-col h-full hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <a href="/services/12-month-video-consultation-plan/" class="block mb-2">
                        ...
                        <div class="text-center mt-2">
                            <a href="/services/12-month-video-consultation-plan/" class="text-sm font-semibold text-imperial-primary hover:underline">See details</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white border-b border-gray-200 faq-wrapper">
                    ...
                    <div class="faq-content hidden pb-6 pl-9 pr-6 text-gray-600">
                        <p>After the consultation, the doctor will upload your prescription to your account, which you can access digitally.</p>
                    </div>
                </div>
    ...
    <script>
        function toggleFaq(button) {
            // Find the wrapper parent to avoid DOM structure issues
            const wrapper = button.closest('.faq-wrapper');
            if (!wrapper) return;

            // Find elements strictly inside the wrapper
