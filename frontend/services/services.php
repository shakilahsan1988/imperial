    ...
    <section class="border-b border-gray-200 py-16 md:py-20">
        <div class="max-w-6xl mx-auto px-6 w-full flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div class="md:w-1/3 flex justify-start md:justify-end w-full">
                <a href="http://localhost/services/service-details.php" class="inline-flex items-center gap-2 text-imperial-primary font-semibold border-2 border-imperial-primary px-8 py-3 rounded hover:bg-imperial-primary hover:text-white transition-colors">
                    Read More
                </a>
            </div>
        </div>
