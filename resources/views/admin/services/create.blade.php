        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-plus-circle mr-2"></i>Service Information
                    </h3>
                </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="e.g., Complete Blood Count" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Short Name</label>
                                        <input type="text" name="short_name" class="form-control" placeholder="e.g., CBC">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="service_sub_category_id" class="form-control" id="subCategorySelect" disabled>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="preparation" class="form-control" rows="2" placeholder="e.g., Fasting 8-12 hours required"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Specimen Type</label>
                                <input type="text" name="specimen_type" class="form-control" placeholder="e.g., Blood, Urine, Stool">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Unit</label>
                                        <input type="text" name="unit" class="form-control" placeholder="e.g., mg/dL, g/L, %">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Normal Reference Range</label>
                                        <input type="text" name="reference_range" class="form-control" placeholder="e.g., 70 - 110, Negative, < 5.0">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="homeVisitAvailable" name="home_visit_available">
                                    <label class="custom-control-label" for="homeVisitAvailable">Available for Home Visit</label>
                                </div>
                            </div>
                            <div class="form-group" id="homeVisitPriceField" style="display: none;">
                                <label>Home Visit Additional Price</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">{{ get_currency() }}</span>
                                    </div>
                                    <input type="number" name="home_visit_price" class="form-control" step="0.01" min="0" placeholder="Extra fee for home visit">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="showOnFrontend" name="show_on_frontend" checked>
