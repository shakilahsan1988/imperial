    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-end mb-2">
            <div class="d-flex align-items-center">
                ...
                <a href="{{ route('admin.patients.export') }}" class="btn btn-success shadow-sm mr-2">
                ...
                <a href="{{ route('admin.patients.create') }}" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus mr-1"></i> {{ __('Create Patient') }}
                </a>
                @endif
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h3 class="card-title font-weight-bold mb-0">
                        <i class="fas fa-table mr-2 text-primary"></i>{{ __('Patients Table') }}
                    </h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="patients_table" class="table table-hover align-middle" width="100%">
