...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.health_package_bookings.update', $booking->id) }}" method="POST" class="form-inline mb-4">
            @csrf
            @method('PUT')
        ...
        <form action="{{ route('admin.health_package_bookings.payments.store', $booking->id) }}" method="POST" class="row">
            @csrf
            <div class="col-md-3">
                <label>Amount</label>
            ...
            <div class="col-12 mt-3">
                ...
                <a href="{{ route('admin.health_package_bookings.invoice', $booking->id) }}" target="_blank" class="btn btn-secondary">Print Invoice</a>
            </div>
        </form>
