...
<head>
    ...
    <title>Health Check Invoice #{{ $booking->id }}</title>
...
<body>
    <div class="invoice-wrap">
        <div class="d-flex justify-content-between align-items-start mb-4">
            <div>
                <h4 class="mb-1">Health Check Invoice</h4>
                <div class="text-muted">Invoice #HC-{{ str_pad($booking->id, 6, '0', STR_PAD_LEFT) }}</div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <div class="value">{{ optional($booking->package)->name ?: '-' }}</div>
                <div class="label mt-2">Category</div>
                <div class="value">{{ optional(optional($booking->package)->category)->name ?: '-' }}</div>
                <div class="label mt-2">Preferred Date</div>
                <div class="value">{{ optional($booking->preferred_date)->format('Y-m-d') ?: '-' }}</div>
            </div>
        </div>
