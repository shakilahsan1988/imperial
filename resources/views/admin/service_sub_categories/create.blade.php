@extends('layouts.app')
@section('title', 'Create Service Sub Category')

@section('header')
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h3 class="mb-0">Create New Sub Category</h3>
        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-plus-circle mr-2"></i>Sub Category Information
                    </h3>
                </div>
                <form action="{{ route('admin.service_sub_categories.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="e.g., Clinical Pathology" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
