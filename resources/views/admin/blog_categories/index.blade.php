...
<div class="card shadow-sm border-0">
    <div class="card-body table-responsive">
        <table class="table table-hover">
            ...
            @forelse($categories as $category)
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <form method="POST" action="{{ route('admin.blog_categories.destroy', $category->id) }}" class="d-inline">
                            @csrf
                            @method('DELETE')
            ...
            @empty
                <tr><td colspan="4" class="text-center text-muted">No blog categories found.</td></tr>
            @endforelse
            </tbody>
        </table>
        {{ $categories->links() }}
