...
<div id="mobile-menu" class="fixed inset-y-0 left-0 w-[300px] bg-white shadow-[25px_0_60px_rgba(0,0,0,0.1)] transform -translate-x-full z-[10001] transition-transform duration-500 ease-in-out lg:hidden overflow-y-auto pt-24 px-8 flex flex-col gap-2 pointer-events-auto">
    ...
    <a href="{{ route('fhome') }}" class="text-lg font-bold text-slate-700 hover:text-indigo-600 py-3 transition-all flex items-center justify-between group">
        <span>Home</span>
    ...
    <div class="py-1">
        <button class="w-full flex justify-between items-center py-3 text-lg font-bold text-slate-700 hover:text-indigo-600 transition-all" onclick="toggleMobileSubmenu('mobile-services')">
            <span>Services</span>
            <i class="fa-solid fa-chevron-down text-[10px] transition-transform duration-300" id="mobile-services-icon"></i>
        </button>
        <div id="mobile-services" class="hidden pl-4 pb-4 space-y-4 mt-2">
            <a href="{{ route('lab-test') }}" class="block text-sm font-bold text-slate-500 hover:text-indigo-600 flex items-center gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-indigo-400"></span> Diagnostics & Lab
            </a>
            <a href="{{ route('health-check') }}" class="block text-sm font-bold text-slate-500 hover:text-indigo-600 flex items-center gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-indigo-400"></span> Health Checks
            </a>
            <a href="{{ route('membership') }}" class="block text-sm font-bold text-slate-500 hover:text-indigo-600 flex items-center gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-indigo-400"></span> Membership Plan
            </a>
            <a href="{{ route('video-consultation') }}" class="block text-sm font-bold text-slate-500 hover:text-indigo-600 flex items-center gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-indigo-400"></span> Video Consultation
            </a>
        </div>
    </div>

    <a href="{{ route('doctor') }}" class="text-lg font-bold text-slate-700 hover:text-indigo-600 py-3 transition-all flex items-center justify-between group">
    ...
    <div class="py-1">
        <button class="w-full flex justify-between items-center py-3 text-lg font-bold text-slate-700 hover:text-indigo-600 transition-all" onclick="toggleMobileSubmenu('mobile-community')">
            <span>Community</span>
            <i class="fa-solid fa-chevron-down text-[10px] transition-transform duration-300" id="mobile-community-icon"></i>
        </button>
        <div id="mobile-community" class="hidden pl-4 pb-4 space-y-4 mt-2">
            <a href="{{ route('blog') }}" class="block text-sm font-bold text-slate-500 hover:text-indigo-600 flex items-center gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-indigo-400"></span> Blog
            </a>
            <a href="{{ route('gallery') }}" class="block text-sm font-bold text-slate-500 hover:text-indigo-600 flex items-center gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-indigo-400"></span> Gallery
            </a>
        </div>
    </div>
    ...
    <div class="py-1">
        <button class="w-full flex justify-between items-center py-3 text-lg font-bold text-slate-700 hover:text-indigo-600 transition-all" onclick="toggleMobileSubmenu('mobile-about')">
            <span>About</span>
            <i class="fa-solid fa-chevron-down text-[10px] transition-transform duration-300" id="mobile-about-icon"></i>
        </button>
