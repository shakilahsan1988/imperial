    ...
    <div class="container mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <nav class="hidden lg:flex gap-8 items-center">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-2 mb-6">
                                        <li><a href="{{ route('services') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Consultations</a></li>
                                        <li><a href="{{ route('video-consultation') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Video Consultation</a></li>
                                    </ul>
                                    <h5 class="text-imperial-primary font-bold mb-4 uppercase text-sm tracking-wider">Health Checks</h5>
                                    <ul class="space-y-2">
                                        <li><a href="{{ route('health-check') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Health Checks</a></li>
                                        <!-- Mapping generic sub-items to the main health check page -->
                                        <li><a href="{{ route('health-check') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Men's Health Packages</a></li>
                                        <li><a href="{{ route('health-check') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Senior Citizen Checks</a></li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        <li><a href="{{ route('lab-test') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Lab Tests & Diagnostics</a></li>
                                        <li><a href="{{ route('lab-test') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Imaging & X-Ray</a></li>
                                        <li><a href="{{ route('service-details') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Molecular Cancer Diagnostics</a></li>
                                        <li><a href="{{ route('service-details') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Home Sample Collection</a></li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li><a href="#" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Pharmacy</a></li>
                                        <li><a href="{{ route('service-details') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Vaccines</a></li>
                                        <li><a href="{{ route('membership') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Membership Plans</a></li>
                                        <li><a href="{{ route('service-details') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">COVID-19 Services</a></li>
                                    </ul>
                                </div>
                ...
                <div class="relative group py-4"> 
                    <a href="{{ route('about') }}" class="text-imperial-text font-medium hover:text-imperial-primary transition">About</a>
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2 top-full mt-0 w-[75vw] max-w-[1200px] bg-white shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border-b border-gray-100 rounded-lg">
                        <div class="container mx-auto px-6 py-10">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                                ...
                                <!-- Column 1: Company -->
                                <div>
                                    <h5 class="text-imperial-primary font-bold mb-4 uppercase text-sm tracking-wider">Company</h5>
                                    <ul class="space-y-2 mb-6">
                                        <li><a href="{{ route('about') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">About Us</a></li>
                                        <li><a href="{{ route('mission-vision-value') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Mission & Vision</a></li>
                                        <li><a href="{{ route('management') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Management Team</a></li>
                                    </ul>
                                </div>

                                <!-- Column 2: Quality -->
                                <div>
                                    <h5 class="text-imperial-primary font-bold mb-4 uppercase text-sm tracking-wider">Quality & Safety</h5>
                                    <ul class="space-y-2">
                                        <li><a href="{{ route('bill-of-right') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Patient Bill of Rights</a></li>
                                        <li><a href="{{ route('code-of-ethics') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Code of Ethics</a></li>
                                        <li><a href="{{ route('career') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Careers</a></li>
                                    </ul>
                                </div>

                                <!-- Column 3: News -->
                                <div>
                                    <h5 class="text-imperial-primary font-bold mb-4 uppercase text-sm tracking-wider">News & Media</h5>
                                    <ul class="space-y-2">
                                        <li><a href="{{ route('blog') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Blog</a></li>
                                        <li><a href="{{ route('press') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Press Releases</a></li>
                                        <li><a href="{{ route('event') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Events</a></li>
                                        <li><a href="{{ route('client') }}" class="text-gray-700 hover:text-imperial-primary font-medium block py-1">Our Clients</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="relative h-full min-h-[250px] flex flex-col justify-end bg-gray-50 rounded-lg overflow-hidden group/img">
                                    <img src="https://picsum.photos/seed/hospital/400/300" 
                                         ...
                                         alt="About Imperial">
                                    <div class="relative z-10 bg-white/95 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-gray-100">
                                        <h4 class="text-imperial-text font-bold mb-2 text-lg">Join Our Team</h4>
                                        <p class="text-sm text-gray-600 mb-4">Explore career opportunities at Imperial Health.</p>
                                        <a href="{{ route('career') }}" class="block w-full bg-imperial-primary text-white text-sm font-bold px-4 py-3 rounded hover:bg-imperial-dark transition text-center">
                                            View Openings
                                        </a>
                                    </div>
                                </div>
