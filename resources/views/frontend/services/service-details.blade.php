            ...
            <section class="mb-24">
                ...
                <div class="flex flex-col md:flex-row items-start gap-12 mb-24">
                    <div class="flex-1">
                        ...
                        <a href="{{ route('book-doctor') }}" class="inline-block border border-imperial-primary text-imperial-primary px-8 py-3 font-medium hover:bg-imperial-primary hover:text-white transition">
                            Book an Appointment
                        </a>
