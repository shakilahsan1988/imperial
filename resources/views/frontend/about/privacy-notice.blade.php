...
@section('title', 'Privacy Notice - Imperial Health Bangladesh')
    ...
    <main class="font-sans text-imperial-text bg-white pb-20">
        ...
        <section class="relative w-full h-[400px] md:h-[500px] flex items-center overflow-hidden">
            ...
            <div class="absolute inset-0 z-0">
                <!-- Professional placeholder image suitable for Privacy/Legal pages -->
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700">
                        ...
                        <div class="mb-10">
                            ...
                            <p class="text-gray-700 mb-3">We collect personal information that you voluntarily provide to us when you register on our website, express an interest in obtaining information about us or our products and services, when you participate in activities on our website, or otherwise when you contact us.</p>
                        ...
                        <div class="mb-10">
                            ...
                            <p class="text-gray-700 mb-3">We use information we collect to provide, maintain, and improve our services, and to process transactions. Specifically, we may use your information to:</p>
                            <ul class="list-disc list-outside ml-6 space-y-2">
                                <li>Facilitate your access to and use of website and services.</li>
                        ...
                        <div class="mb-10">
                            ...
                            <ul class="list-disc list-outside ml-6 space-y-2">
                                ...
                                <li><strong class="text-gray-900">Legal Requirements:</strong> We may disclose information where we believe it is necessary to investigate, prevent, or take action regarding illegal activities, fraud, or potential threats to physical safety of any person.</li>
                            </ul>
                        </div>
                        ...
                        <div class="mb-10">
                            ...
                            <ul class="list-disc list-outside ml-6 space-y-2">
                                <li>The right to access, update, or delete information we have on you.</li>
