        ...
        <section class="bg-white border-b border-gray-200 py-3">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <nav class="flex text-sm text-gray-500">
                    ...
                    <a href="{{ route('doctor') }}" class="hover:text-imperial-primary transition">Doctors</a>
                    <span class="mx-2 text-gray-400">/</span>
                ...
                <div class="lg:col-span-8 space-y-6">
                        ...
                        <div class="flex flex-col md:flex-row gap-8">
                            ...
                            <div class="flex-1 text-center md:text-left">
                                ...
                                <div class="prose max-w-none text-gray-600 text-sm leading-relaxed">
                                    <p>Dr. Ahmed Farukh completed his MBBS from RMC and is a bio-energetic medicine specialist. He has over 21 years of experience including working at Health Complex, Mitford Hospital, and as a Resident Medical Officer in hospitals under Ministry of Health, Saudi Arabia. Over the course of his career, Dr. Ahmed attended several training sessions at home and abroad in Germany, Switzerland, Singapore, and Bangkok.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                            ...
                            <!-- Date Card 1 -->
                            <div class="border border-gray-200 rounded-lg p-4 hover:border-imperial-primary hover:bg-blue-50 transition cursor-pointer flex justify-between items-center relative group">
                                <div>
